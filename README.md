...
![Continuous Integration](https://github.com/hackariens/angular/workflows/Continuous%20Integration/badge.svg?branch=develop)
...
```sh
git clone git@github.com:hackariens/angular.git template-angular
cd template-angular
